...
(function($) {
	...
	// classes Carousel birth
	if ($('.classes-carousel-b').length) {
		$('.classes-carousel-b').owlCarousel({
			animateOut: 'slideOutDown',
    		animateIn: 'fadeIn',
			loop:true,
			margin:30,
...
// classes Carousel birth
	if ($('.classes-carousel-t').length) {
		$('.classes-carousel-t').owlCarousel({
			animateOut: 'slideOutDown',
    		animateIn: 'fadeIn',
			loop:true,
			margin:30,

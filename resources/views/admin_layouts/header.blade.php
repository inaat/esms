                    ...
                    <div class="top-menu-left d-none d-lg-block">
                        <ul class="nav">
                             @can('whatsapp_check.view')
                              <li class="nav-item">
                                <a class="nav-link whatsapp-check-login"  href="#" data-href="{{ action('WhatsAppController@checkLogin') }}" data-container=".view_modal"><i class='lni lni-whatsapp'></i><span class="whatappstatus"></span></a>
                              </li>
                              @endcan
                            @can('device.sync')
                              <li class="nav-item">

                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         ...
                                         <button type="button" class="btn btn-danger btn-xs delete_payment" data-href="{{ action('FeeTransactionPaymentController@destroy', [$payment->id]) }}"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                                     @endcan
                                 </tr>
                                 @endforeach
                             </tbody>

                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-3 p-1">
                                ...
                                {!! Form::email('guardian[guardian_email]', $student->guardian->student_guardian->guardian_email, ['class' => 'form-control','id'=>'guardian_email', 'placeholder' => __('english.guardian_email')]) !!}
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-md-3 p-1">

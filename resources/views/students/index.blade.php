                             ...
                             <div class="accordion-body">
                                 <div class="row">
                                     ...
                                     <div class="col-md-4 p-1">
                                         ...
                                         {!! Form::select('adm_class_section_id', [], null, ['class' => 'form-select select2 global-class_sections', 'id' => 'students_list_filter_class_section_id', 'required', 'style' => 'width:100%', 'required', 'placeholder' => __('english.all')]) !!}
                                     </div>

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('english.manage_your_awards')</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">@lang('english.awards')</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('english.awards_list')
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    ...
                    <div class="ms-auto"><button type="button" class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-modal" data-href="{{ action('AwardController@create') }}" data-container=".award_modal">
                            <i class="bx bxs-plus-square"></i>@lang('english.add_new_award')</button></div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0" width="100%" id="awards_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                <th>@lang('english.award_title')</th>

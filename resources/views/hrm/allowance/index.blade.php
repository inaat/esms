...
@section('title', __('english.allowance'))
@section('wrapper')
<div class="page-wrapper">
    <div class="page-content">
        <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('english.all_your_allowances')</div>
            <ol class="breadcrumb mb-0 p-0">
                <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">@lang('english.allowances')</li>
            </ol>
            </nav>
        </div>
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('english.allowance_list')
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button" class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-modal" data-href="{{ action('Hrm\HrmAllowanceController@create') }}" data-container=".allowances_modal">
                                <i class="bx bxs-plus-square"></i>@lang('english.add_new_allowance')</button></div>
                        @endcan
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" width="100%" id="allowances_table">
                            <thead class="table-light" width="100%">
                                <tr>
                                    <th>@lang('english.allowance_name')</th>

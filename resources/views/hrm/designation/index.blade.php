...
@section('title', __('english.designations'))
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
            <!--breadcrumb-->
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">@lang('english.all_your_designations')</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{ url('/home') }} "><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('english.designations')</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('english.designation_list')
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button"
                                ...
                                data-href="{{ action('Hrm\HrmDesignationController@create') }}"
                                data-container=".designations_modal">
                                <i class="bx bxs-plus-square"></i>@lang('english.add_new_designation')</button></div>
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0" width="100%" id="designations_table">
                            <thead class="table-light" width="100%">
                                <tr>
                                    <th>@lang('english.designation_name')</th>

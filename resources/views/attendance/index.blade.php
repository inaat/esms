...
@section('title', __('english.student_attendance'))
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-4 p-1">
                                     ...
                                     <div class="col-md-3 p-1">
                                        ...
                                        {!! Form::select('status', __('english.attendance_status'), 'present', ['class' => 'form-control','id'=>'list_filter_status','placeholder' => __('english.please_select'), 'required']); !!}
                                    </div>
                                     <div class="col-md-3 p-1">
 ...
 <script type="text/javascript">
     $(document).ready(function() {
         ...
         $(document).on('change'
             , '#list_filter_campus_id,#list_filter_status,#list_filter_date_range,#list_filter_class_id,#list_filter_class_section_id'
             , function() {

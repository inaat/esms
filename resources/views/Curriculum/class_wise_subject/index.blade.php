...
@section('wrapper')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title text-primary">@lang('english.class'):{{ $class_section_detail->classes->title }} Section :{{ $class_section_detail->section_name }}  Subject List
                    ...
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto"><button type="button"
                                ...
                                data-href="{{ action('Curriculum\CurriculumController@create',[$class_section_id]) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var class_subjects_table = $("#class_subjects_table").DataTable({
                processing: true,
                serverSide: true,
                ajax: "/class-curriculum/{{ $class_section_id }}",
                columns: [{
                    data: "subject_name",
                    name: "subject_name"
                }, {

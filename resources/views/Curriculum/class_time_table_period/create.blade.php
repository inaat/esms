<div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header bg-primary">
            <h5 class="modal-title" id="exampleModalLabel">@lang('english.add_new_period')</h5>
            ...
            <div class="row ">
               <div class="col-md-12 p-2 ">
                ...
                <div class="col-md-12 p-2">
                    ...
                    {!! Form::text('name',  null, ['class' => 'form-control', 'placeholder' => __('english.name'), 'required']) !!}

                </div>
                <div class="col-md-12 p-2">
                    {!! Form::label('type', __('english.type') . ':*') !!} 
                    {!! Form::select('type', __('english.period_type'),  null, ['class' => 'form-control select2', 'required','placeholder' => __('english.please_select')]) !!}

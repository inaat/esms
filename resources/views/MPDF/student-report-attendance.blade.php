...
<body>
   ...
   @if($data['student']->count()>0)
    <div class="card">
        ...
        <h5 class="head text-primary">@lang('english.attendance_list') @lang('english.of') @lang('english.class') :<span class="mg-left">{{ $data['student'][0]->current_class->title }}</span><span class="mg-left">{{ $data['student'][0]->current_class_section->section_name}}</span></h5>

           ...
           <div class="modal-body">
                   <div class="row ">
                       ...
                       <div class="col-md-4 p-2">
                           ...
                           {!! Form::select('subject_id', $classSubject,$date_sheet->subject_id, ['class' => 'form-select select2 global-section-subjects', 'id' => 'global-section-subjects', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                       </div>

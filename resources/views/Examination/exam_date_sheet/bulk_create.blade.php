        ...
        <div class="modal-body">
            <div class="row ">
                ...
                <div class="col-md-4 p-2">
                    ...
                    {!! Form::select('class_section_id', [], null, ['class' => 'form-select select2 global-class_sections','multiple', 'required', 'style' => 'width:100%', 'placeholder' => __('english.please_select')]) !!}
                </div>
                ...
                <div class="col-md-4 p-2">
                    ...
                    <div class="input-group flex-nowrap"> <span class="input-group-text" id="addon-wrapping"><i class="fa fa-calendar"></i></span>
                        ...
                        {!! Form::text('date',@format_date('now'), ['class' => 'form-control date-picker date-sheet-date', 'readonly', 'placeholder' => __('english.date')]) !!}

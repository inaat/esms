    ...
    <div class="container abooutContent">
        <div class="row">
            <div class="col-md-4  d-flex">
                <div class="card sidebar radius-10 p-0 w-100 p-3">
                    <div class="card-body">
                            <ul>
                               @foreach ($nav as  $bar)
                             <li class=" {{ $data->id==$bar->id ? 'active'  : '' }}   mx-auto"><a href="{{ action('Frontend\FrontHomeController@about_show', [$bar->slug,$bar->id]) }}">{{ $bar->title }}</a></li>
                               @endforeach
            ...
            <div class="col-md-8">
               ...
               <div class="col-sm-12">
                   <div class="chimg">
                       <img src="{{url('uploads/front_image/'.$data->image)}}">
                       </div>

                            ...
                            <div class="footer-about mt-40" align="right">
                                ...
                                <ul class="mt-20">
                                   @if(!empty(session()->get("front_details.facebook")))
                                    ...
                                    @endif
                                    {{-- <li><a href="https://twitter.com/IslamabadNursi2" target="_blank"><i
                                                class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.linkedin.com/in/islamabad-nursing-3a123a201/"
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul style="padding-left: 10px">
                                <li><a href="index-2.html"><i class="fa fa-angle-right"></i>HOME</a></li>
                                <li><a href="about_university.html"><i class="fa fa-angle-right"></i>ABOUT
                                        UNIVERSITY</a></li>
 ...
 <div id="myModal" class="modal fade">
   ...
   <a href="https://admissions.imdcollege.edu.pk/" target="_blank"><img src="{{ url('front/images/inc.jpeg') }}" alt=""/></a>       </div>
        </div>
 </div></div>
-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0 " href="{{ action('Frontend\FrontGalleryController@addImage',[$gallery->id]) }}" >
                        ...
                        <thead class="table-light" width="100%">
                          ...
                          <tbody>
					       @if(!empty($getJson))
							...
							<td><a href="{{ action('Frontend\FrontGalleryController@upload_delete',[$gallery->id,$key]) }}" class="btn btn-sm btn-danger delete_element_button"><i class="bx bxs-trash f-16 mr-15 text-white"></i> @lang("english.delete")</a></td>

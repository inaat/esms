...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        {!! Form::open(['url' => action('Frontend\FrontGalleryController@storeElement',[$gallery->id]), 'method' => 'PUT', 'id' =>'' ,'files' => true]) !!}

        <div class="row">
            <div class="col-xl-9 mx-auto">
                {!! Form::label('name', __('english.type' ) . ':*') !!}
                {!! Form::select('type', ['1' => 'Photo', '2' => 'Video URL'],1, ['class' => 'form-select select2', 'required', 'id' => 'type', 'style' => 'width:100%']) !!}
            </div>
        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                    {!! Form::file('thumb_image[]', ['accept' => 'image/*','class' => 'form-control upload_thumb_image','multiple']); !!} </div>
                    </div>
                </div>
            </div>
        </div>

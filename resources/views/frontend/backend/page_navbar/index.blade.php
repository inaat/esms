...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">@lang('english.manage_your_custom_navbar')</div>
            <div class="ps-3">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title text-primary">@lang('english.custom_navbar_list')</h5>
                @can('slider.create')
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0 " href="{{ action('Frontend\FrontCustomPageNavbarController@create') }}" >
                            <i class="bx bxs-plus-square"></i>@lang('english.add_new_custom_navbar')</a></div>
                </div>
                @endcan

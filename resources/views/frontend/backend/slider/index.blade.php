        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <div class="ms-auto"><a class="btn btn-primary radius-30 mt-2 mt-lg-0 btn-slider-modal" href="#" data-href="{{ action('Frontend\FrontSliderController@create') }}" data-container=".slider_modal">
                    ...
                    <table class="table mb-0" width="100%" id="slider_table">
                        <thead class="table-light" width="100%">
                            <tr>
                                ...
                                <th>@lang( 'english.slider_title' )</th>
                                <th>@lang( 'english.description' )</th>
                                <th>@lang( 'english.btn_name' )</th>
                                <th>@lang( 'english.btn_url' )</th>

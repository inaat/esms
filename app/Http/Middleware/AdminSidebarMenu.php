...
class AdminSidebarMenu
{
    ...
    private function adminSidebar()
    {
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            //attendance
            if (auth()->user()->can('student_attendance.view')|| auth()->user()->can('employee_attendance.view')
            ...
            if (auth()->user()->can('employee.view') || auth()->user()->can('employee.create') || auth()->user()->can('shift.view')|| auth()->user()->can('department.create')|| auth()->user()->can('designation.view')||auth()->user()->can('deduction.view')||

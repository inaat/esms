...
//            dd('ok');
        ...
        ->removeColumn('id');
            ...
            $rawColumns = ['action','status','campus_name','transaction_class','transaction_date','voucher_no','payment_status','final_total','total_remaining','total_paid','roll_no','month'];

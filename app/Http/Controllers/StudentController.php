...
if ($row->total_admission_fee<=0) {
    $html.='<li><a class="dropdown-item admission_add_button " href="#" data-href="' . action('StudentController@addAdmissionFee', [$row->id]) . '"><i class="bx bxs-plus-square "></i> ' . __("english.add_admission_fee") . '</a></li>';
            ...
            $rawColumns = ['action','campus_name','adm_class','current_class','birth_date','father_name','status','student_name','student_tuition_fee','student_transport_fee','total_due','admission_date'];
        ...
        return view('students.index')->with(compact('campuses', 'vehicles'));
    }
